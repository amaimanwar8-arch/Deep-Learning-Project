...
This project presents a complete deep learning pipeline for automated pneumonia detection from Chest X-Ray images using a Vision Transformer (ViT) architecture. The work focuses on improving the stability and efficiency of transfer learning for medical imaging tasks with limited labeled data.
...
Reduced trainable parameters from 86M → 14M using selective layer freezing
